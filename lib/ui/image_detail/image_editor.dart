    ...
    return Stack(children: [
      Scaffold(
          ...
          body: Stack(children: <Widget>[
            ...
            if (WaterMark.show)
              Positioned(
                top: imageRatio == ImageRatio.Instagram? image.height: image.height -10,
              right: imageRatio == ImageRatio.Instagram? 16: 68,
              child: SizedBox(
                width: 20,
                  height: 20,
                child: CustomPaint(painter: ChatBubbleTriangle(direction: imageRatio == ImageRatio.Instagram?DIRECTION.TOP: DIRECTION.RIGHT),
              ),
              )),
            if (WaterMark.show)
              Positioned(
                  top: imageRatio == ImageRatio.Instagram? image.height+10:
                  image.height-40,
                  ...
                  child: InkWell(
                      onTap: () {
                        ...
                        RewardedVideoAd.instance.listener =
                          ...
                          } else if (adEvent == RewardedVideoAdEvent.rewarded) {
